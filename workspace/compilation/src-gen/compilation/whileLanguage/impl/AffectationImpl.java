 ...
 * </p>
 * <ul>
 *   <li>{@link compilation.whileLanguage.impl.AffectationImpl#getAffectations <em>Affectations</em>}</li>
 *   <li>{@link compilation.whileLanguage.impl.AffectationImpl#getValeurs <em>Valeurs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AffectationImpl extends MinimalEObjectImpl.Container implements Affectation
{
  ...
  {
    return WhileLanguagePackage.Literals.AFFECTATION;
  }
  ...
  public EList<String> getAffectations()
  {
    ...
    {
      affectations = new EDataTypeEList<String>(String.class, this, WhileLanguagePackage.AFFECTATION__AFFECTATIONS);
    }
    return affectations;
  }
  ...
  public EList<Expr> getValeurs()
  {
    if (valeurs == null)
    {
      valeurs = new EObjectContainmentEList<Expr>(Expr.class, this, WhileLanguagePackage.AFFECTATION__VALEURS);
    }
    return valeurs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case WhileLanguagePackage.AFFECTATION__VALEURS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WhileLanguagePackage.AFFECTATION__AFFECTATIONS:
