 ...
 * <ul>
 *   <li>{@link compilation.whileLanguage.If#getExpr <em>Expr</em>}</li>
 *   <li>{@link compilation.whileLanguage.If#getCommands1 <em>Commands1</em>}</li>
 *   <li>{@link compilation.whileLanguage.If#getCommands2 <em>Commands2</em>}</li>
 * </ul>
 * </p>
 *
 * @see compilation.whileLanguage.WhileLanguagePackage#getIf()
 * @model
 * @generated
 */
public interface If extends EObject
{
   ...
   * @see #setExpr(Expr)
   * @see compilation.whileLanguage.WhileLanguagePackage#getIf_Expr()
  ...
  /**
   * Sets the value of the '{@link compilation.whileLanguage.If#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see compilation.whileLanguage.WhileLanguagePackage#getIf_Commands1()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link compilation.whileLanguage.If#getCommands1 <em>Commands1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see compilation.whileLanguage.WhileLanguagePackage#getIf_Commands2()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link compilation.whileLanguage.If#getCommands2 <em>Commands2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
